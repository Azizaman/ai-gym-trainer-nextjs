...
function buildPrompt(exerciseType, options) {
...
async function analyzeExerciseVideo(videoBuffer, mimeType, exerciseType, options = {}) {
    ...
    try {
        ...
        const processedFile = await ai.files.get({
        ...
        const response = await ai.models.generateContent({
            ...
            contents: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$genai$2f$dist$2f$node$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUserContent"])([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$genai$2f$dist$2f$node$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPartFromUri"])(processedFile.uri, processedFile.mimeType),
...
function createPrismaClient() {
    const dbPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), "dev.db");
    ...
    try {
        ...
        if (!session?.user?.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Please sign in to analyze videos"
            }, {
                status: 401
            });
        }
        ...
        const exerciseType = formData.get("exerciseType") || "general";
        const fitnessLevel = formData.get("fitnessLevel") || "intermediate";
        if (!video) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        // Validate MIME type
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["config"].SUPPORTED_MIME_TYPES.includes(video.type)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: `Unsupported file type: ${video.type}. Supported: ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["config"].SUPPORTED_MIME_TYPES.join(", ")}`
            }, {
                status: 400
            });
        }
        // Validate file size
        const maxBytes = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["config"].MAX_FILE_SIZE_MB * 1024 * 1024;
        if (video.size > maxBytes) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: `File too large. Max size: ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["config"].MAX_FILE_SIZE_MB} MB`
            }, {
                status: 400
            });
        }
        ...
        // Run analysis
        const feedback = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["analyzeExerciseVideo"])(buffer, video.type, exerciseType, {
            fitnessLevel: fitnessLevel
        });
        // Save to database
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].analysisHistory.create({
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e19424b._.js.map